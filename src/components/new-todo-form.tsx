			...
			<div className="overflow-hidden rounded-lg border border-gray-300 p-2 shadow-sm focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500">
				<div className="mr-4 flex items-center space-x-4">
					<input
						...
						type="text"
						{...register("title", {
							maxLength: { value: 100, message: "Dlouhý název" },
							minLength: { value: 3, message: "Krátký název" },
							required: true,
						})}
					/>
				...
				<div className="relative pb-4">
					<textarea
						...
						rows={5}
						{...register("note", { required: false, maxLength: { value: 255, message: "Dlouhý popis" } })}
					/>
				...
				<div className="flex items-center justify-between space-x-3 border-t border-gray-200 px-2 py-2 sm:px-3">
					<div className="flex-shrink-0">
						<button type="submit" className="ui-button">
							{defaultValues ? "Upravit" : "Vytvořit"}
						</button>
					</div>
				</div>
			</div>
